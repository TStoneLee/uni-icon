...
const writeFileSync = (outputPath, data, format = "utf-8") => {
  fs.outputFileSync(require$$1.posix.join(process$1.cwd(), outputPath), data, format);
};
...
const transformXML2CSS = (cssContent, xmlContent, iconList = []) => {
  if (
    !xmlContent ||
    !xmlContent.svg ||
